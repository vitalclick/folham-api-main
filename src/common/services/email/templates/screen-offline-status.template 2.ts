import { screenDetailsEmailBody } from '../interfaces/notification-emails.interface';

export const screenOfflineNotifcationTemplate = (
  screenDetails: screenDetailsEmailBody,
) => ({
  text: ` Hello Folham, 
  Your Screen is now offline.
  Find the Screen Details below; 
  Screen Name :
  ${screenDetails.name}
  Screen ID :
  ${screenDetails.screenId}
  Screen Status :
  ${screenDetails.screenStatus}`,
  html: `
  ...
  >
    <head>
      ...
      />
      <title>${screenDetails.title}</title>
      <link
                                    ...
                                    >
                                      <div style="line-height: 20px;">
                                        ...
                                        >
                                          ...
                                          Your Screen is now offline <br />
                                          Find the Screen Details below; <br /><br /><br />
                                          <b>Screen Name</b> :
                                          ${screenDetails.name} <br /><br />
                                          <b>Screen ID</b> :
                                          ${screenDetails.screenId}<br /><br />
                                          <b>Screen Status</b> :
                                          ${screenDetails.screenStatus}<br /><br />
                                          <br />
                                          <br /><br />
                                        </span>
                                      </div>
