...
export const campaignExpiryNotifcationTemplate = (
  payload: CampaignPostingNoficationBody,
) => ({
  text: `Hello Folham,

  Your CJ tronics Campaign will be expiring Today 
                                    ...
                                    >
                                      <div style="line-height: 20px;">
                                        ...
                                        >
                                          ...
                                          Your CJ tronics Campaign will be expiring Today <br />
                                          Find the Details below; <br /><br /><br />
                                          <b>Campaign Name</b> :
